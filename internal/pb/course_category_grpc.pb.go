...
type CategoryServiceClient interface {
	...
	CreateCategoryStreamBidirecional(ctx context.Context, opts ...grpc.CallOption) (CategoryService_CreateCategoryStreamBidirecionalClient, error)
...
func (c *categoryServiceClient) CreateCategoryStreamBidirecional(ctx context.Context, opts ...grpc.CallOption) (CategoryService_CreateCategoryStreamBidirecionalClient, error) {
	stream, err := c.cc.NewStream(ctx, &CategoryService_ServiceDesc.Streams[1], "/pb.CategoryService/CreateCategoryStreamBidirecional", opts...)
	if err != nil {
		return nil, err
	}
	x := &categoryServiceCreateCategoryStreamBidirecionalClient{stream}
	return x, nil
}

type CategoryService_CreateCategoryStreamBidirecionalClient interface {
	Send(*CreateCategoryRequest) error
	Recv() (*Category, error)
	grpc.ClientStream
}

type categoryServiceCreateCategoryStreamBidirecionalClient struct {
	grpc.ClientStream
}

func (x *categoryServiceCreateCategoryStreamBidirecionalClient) Send(m *CreateCategoryRequest) error {
	return x.ClientStream.SendMsg(m)
}

func (x *categoryServiceCreateCategoryStreamBidirecionalClient) Recv() (*Category, error) {
	m := new(Category)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
type CategoryServiceServer interface {
	...
	CreateCategoryStreamBidirecional(CategoryService_CreateCategoryStreamBidirecionalServer) error
...
func (UnimplementedCategoryServiceServer) CreateCategoryStreamBidirecional(CategoryService_CreateCategoryStreamBidirecionalServer) error {
	return status.Errorf(codes.Unimplemented, "method CreateCategoryStreamBidirecional not implemented")
}
...
func _CategoryService_CreateCategoryStreamBidirecional_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(CategoryServiceServer).CreateCategoryStreamBidirecional(&categoryServiceCreateCategoryStreamBidirecionalServer{stream})
}

type CategoryService_CreateCategoryStreamBidirecionalServer interface {
	Send(*Category) error
	Recv() (*CreateCategoryRequest, error)
	grpc.ServerStream
}

type categoryServiceCreateCategoryStreamBidirecionalServer struct {
	grpc.ServerStream
}

func (x *categoryServiceCreateCategoryStreamBidirecionalServer) Send(m *Category) error {
	return x.ServerStream.SendMsg(m)
}

func (x *categoryServiceCreateCategoryStreamBidirecionalServer) Recv() (*CreateCategoryRequest, error) {
	m := new(CreateCategoryRequest)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
var CategoryService_ServiceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		...
		{
			StreamName:    "CreateCategoryStreamBidirecional",
			Handler:       _CategoryService_CreateCategoryStreamBidirecional_Handler,
			ServerStreams: true,
			ClientStreams: true,
		},
	},
